...
/*
 * SM-F731N F731NTBS5FZA1 clean target.
 *
 ...
 * FZA1 mm_cache_init() adds cpumask_size() and SLAB_HWCACHE_ALIGN rounds the
...
#else
#define BUILD_VARIANT_LABEL "b5q-F731NTBS5FZA1-clean-root-umh"
#endif

#ifndef BUILD_FINGERPRINT
#define BUILD_FINGERPRINT \
  "samsung/b5qksx/b5q:16/BP2A.250605.031.A3/F731NTBS5FZA1:user/release-keys"
#endif
...
#define P0_FINGERPRINT_HEADER \
  "targets/b5q-F731NTBS5FZA1/p0_fingerprint.h"
#endif
...
#define INIT_TASK_OFF 0x02afa840ULL
#define PREPARE_KERNEL_CRED_OFF 0x0011e048ULL
#define COMMIT_CREDS_OFF 0x0011fd84ULL
#define OVERRIDE_CREDS_OFF 0x0011ee5cULL
#define ROOT_TASK_GROUP_OFF 0x02baaac0ULL
#define SELINUX_ENFORCING_OFF 0x02c7f430ULL
#define KMALLOC_CACHES_OFF 0x01f9dd18ULL
#define ANON_PIPE_BUF_OPS_OFF 0x01dc84a0ULL
#define SYSTEM_UNBOUND_WQ_OFF 0x02990800ULL
#define CALL_USERMODEHELPER_EXEC_WORK_OFF 0x00104160ULL

#define ASHMEM_FOPS_OFF 0x01f47160ULL
#define ASHMEM_MISC_FOPS_OFF 0x02af27a8ULL
#define ASHMEM_IOCTL_OFF 0x010c0834ULL
#define ASHMEM_COMPAT_IOCTL_OFF 0x010c0e90ULL
#define ASHMEM_MMAP_OFF 0x010c0ee8ULL
#define ASHMEM_OPEN_OFF 0x010c11c8ULL
#define ASHMEM_RELEASE_OFF 0x010c1260ULL
#define ASHMEM_SHOW_FDINFO_OFF 0x010c137cULL
#define CONFIGFS_READ_ITER_OFF 0x005d5ef0ULL
#define CONFIGFS_BIN_WRITE_ITER_OFF 0x005d6918ULL
#define COPY_SPLICE_READ_OFF 0x00526b64ULL
#define NOOP_LLSEEK_OFF 0x004b9a28ULL
...
#define SLIDE_NFULNL_LOGGER_NAME_OFF 0x01cbb187ULL
#define SLIDE_NFULNL_LOGGER_OBJECT_OFF 0x02991e48ULL
#define SLIDE_RANDOM_TABLE_BOOT_ID_DATA_PTR_OFF 0x02ab0338ULL
#define SLIDE_INIT_TASK_OFF INIT_TASK_OFF
#define SLIDE_ROOT_TASK_GROUP_OFF ROOT_TASK_GROUP_OFF
#define SLIDE_SYSCTL_BOOTID_OFF 0x02d1bf31ULL
