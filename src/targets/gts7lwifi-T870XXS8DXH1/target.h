...
#error "gts7lwifi-T870XXS8DXH1 is diagnostic-only; build the app payload"
#endif

#define BUILD_VARIANT_LABEL \
  "gts7lwifi-T870XXS8DXH1-app-page-prepare-single-diagnostic"
...
#define COPY_SPLICE_READ_OFF 0x002900f4ULL
