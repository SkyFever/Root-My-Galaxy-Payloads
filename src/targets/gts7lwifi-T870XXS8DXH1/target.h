...
#define BUILD_VARIANT_LABEL \
  "gts7lwifi-T870XXS8DXH1-app-tracefs-fastrpc-cpu-local"
...
#define ROOT_SIG_ENFORCE_OFF 0x031ca980ULL
#define ROOT_DEFEX_BOOT_STATE_UNLOCKED_OFF 0x02916381ULL
...
#define ROOT_SIG_ENFORCE \
  (KIMAGE_TEXT_BASE + ROOT_SIG_ENFORCE_OFF)
#define ROOT_DEFEX_BOOT_STATE_UNLOCKED \
  (KIMAGE_TEXT_BASE + ROOT_DEFEX_BOOT_STATE_UNLOCKED_OFF)
